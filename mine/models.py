...
class Order(models.Model):
    """订单模型"""
    sn = models.CharField('订单编码', max_length=32)
    ...
    def get_cart_products(self):
        """购物车中  已下单的商品"""
        # 排除还在购物车状态的商品
        # self.carts是Cart模型中order字段的related_name
...
class Cart(models.Model):
    ...
    # 关联到订单
    order = models.ForeignKey(Order, related_name='carts', verbose_name='订单', null=True)
    # 商品快照
