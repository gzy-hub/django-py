# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2020-01-27 01:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.SmallIntegerField(choices=[(11, '实物商品'), (12, '虚拟')], default=11, verbose_name='商品类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(null=True, upload_to='tags', verbose_name='主图')),
                ('code', models.CharField(blank=True, max_length=32, null=True, verbose_name='编码')),
                ('name', models.CharField(max_length=12, verbose_name='名称')),
                ('reorder', models.SmallIntegerField(default=0, verbose_name='排序')),
                ('is_valid', models.BooleanField(default=True, verbose_name='是否有效')),
